    ...
    messages = [
        SystemMessage(
            content=(
                ...
                "8. You must answer the question in a concise manner.\n"
                "9. You must answer the question in a friendly manner.\n"
                "10. If the user does not specify a discount tier, ask them which tier to use - do NOT assume one."
            )
        ),
